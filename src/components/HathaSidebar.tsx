  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-sage-100 flex items-center justify-between px-4 h-14">
        ...
        <span className="font-serif text-base text-gray-900">Hatha Yoga</span>
        <Link
          href="/"
      ...
      >
        ...
        <div className="p-6 border-b border-sage-100 bg-sage-50">
          <Link href="/hatha-yoga" className="block">
                          ...
                          if (hasSubGroups) {
                            ...
                            return (
                              <ul className="ml-4 mt-1 border-l border-sage-100 pl-3">
                                {groups.map((group) => (
                                  <li key={group}>
                                    <p className="text-xs text-gray-400 uppercase tracking-wider px-3 pt-3 pb-1">{group}</p>
                                    <ul className="space-y-1">
                                      {subTopics.filter(t => t.subGroup === group).map((sub) => {
