...
import { getAdjacentHathaTopics } from '@/lib/hathaTopics';

interface HathaTopicNavigationProps {
  currentTopicId: string;
}

export default function HathaTopicNavigation({ currentTopicId }: HathaTopicNavigationProps) {
  const { prev, next } = getAdjacentHathaTopics(currentTopicId);
